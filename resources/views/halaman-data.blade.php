			...
			<table class="table table-striped table-hover">
				<thead>
					<tr>
						...
						<th>Alamat</th>
						<th>Jumlah Kecelakaan Tunggal</th>
						<th>Jumlah Kecelakaan Ganda</th>
				...
				<tbody>
                    ...
                    <tr>
						...
						<td>{{$item->alamat}}</td>
						<td>{{$item->jumlah_kecelakaan_tunggal}}</td>
						<td>{{$item->jumlah_kecelakaan_ganda}}</td>
						<td>{{$item->jumlah_kecelakaan_tunggal+$item->jumlah_kecelakaan_ganda}}</td>
						<td class="w-25">
